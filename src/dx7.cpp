...
void DX7::set_params(void)
{
  ...
  synth_unit_->onParam(29,static_cast<char>(*p(p_op5_output_level)));
  synth_unit_->onParam(30,static_cast<char>(*p(p_op5_mode)));
  synth_unit_->onParam(31,static_cast<char>(*p(p_op5_f_coarse)));
  synth_unit_->onParam(32,static_cast<char>(*p(p_op5_f_fine)));
  synth_unit_->onParam(33,static_cast<char>(*p(p_op5_osc_detune))+7);
  synth_unit_->onParam(34,static_cast<char>(*p(p_op5_break_point)));
  synth_unit_->onParam(35,static_cast<char>(*p(p_op5_l_scale_depth)));
  synth_unit_->onParam(36,static_cast<char>(*p(p_op5_r_scale_depth)));
  synth_unit_->onParam(37,static_cast<char>(*p(p_op5_l_key_curve)));
  synth_unit_->onParam(38,static_cast<char>(*p(p_op5_r_key_curve)));
  synth_unit_->onParam(39,static_cast<char>(*p(p_op5_rate_scaling)));
  synth_unit_->onParam(40,static_cast<char>(*p(p_op5_a_mod_sens)));
  synth_unit_->onParam(41,static_cast<char>(*p(p_op5_key_velocity)));
  // OP4
