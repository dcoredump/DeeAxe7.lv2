...
void DeeAxe7::set_params(void)
{
  ...
  synth_unit_->onParam(8,static_cast<char>(*p(p_op6_break_point)));
  synth_unit_->onParam(9,static_cast<char>(*p(p_op6_l_scale_depth)));
  synth_unit_->onParam(10,static_cast<char>(*p(p_op6_r_scale_depth)));
  synth_unit_->onParam(11,static_cast<char>(*p(p_op6_l_key_curve)));
  synth_unit_->onParam(12,static_cast<char>(*p(p_op6_r_key_curve)));
  synth_unit_->onParam(13,static_cast<char>(*p(p_op6_rate_scaling)));
  synth_unit_->onParam(14,static_cast<char>(*p(p_op6_a_mod_sens)));
  synth_unit_->onParam(15,static_cast<char>(*p(p_op6_key_velocity)));
  synth_unit_->onParam(16,static_cast<char>(*p(p_op6_output_level)));
  synth_unit_->onParam(17,static_cast<char>(*p(p_op6_mode)));
  synth_unit_->onParam(18,static_cast<char>(*p(p_op6_f_coarse)));
  synth_unit_->onParam(19,static_cast<char>(*p(p_op6_f_fine)));
  ...
  synth_unit_->onParam(29,static_cast<char>(*p(p_op5_break_point)));
  synth_unit_->onParam(30,static_cast<char>(*p(p_op5_l_scale_depth)));
  synth_unit_->onParam(31,static_cast<char>(*p(p_op5_r_scale_depth)));
  synth_unit_->onParam(32,static_cast<char>(*p(p_op5_l_key_curve)));
  synth_unit_->onParam(33,static_cast<char>(*p(p_op5_r_key_curve)));
  synth_unit_->onParam(34,static_cast<char>(*p(p_op5_rate_scaling)));
  synth_unit_->onParam(35,static_cast<char>(*p(p_op5_a_mod_sens)));
  synth_unit_->onParam(36,static_cast<char>(*p(p_op5_key_velocity)));
  synth_unit_->onParam(37,static_cast<char>(*p(p_op5_output_level)));
  synth_unit_->onParam(38,static_cast<char>(*p(p_op5_mode)));
  synth_unit_->onParam(39,static_cast<char>(*p(p_op5_f_coarse)));
  synth_unit_->onParam(40,static_cast<char>(*p(p_op5_f_fine)));
  ...
  synth_unit_->onParam(50,static_cast<char>(*p(p_op4_break_point)));
  synth_unit_->onParam(51,static_cast<char>(*p(p_op4_l_scale_depth)));
  synth_unit_->onParam(52,static_cast<char>(*p(p_op4_r_scale_depth)));
  synth_unit_->onParam(53,static_cast<char>(*p(p_op4_l_key_curve)));
  synth_unit_->onParam(54,static_cast<char>(*p(p_op4_r_key_curve)));
  synth_unit_->onParam(55,static_cast<char>(*p(p_op4_rate_scaling)));
  synth_unit_->onParam(56,static_cast<char>(*p(p_op4_a_mod_sens)));
  synth_unit_->onParam(57,static_cast<char>(*p(p_op4_key_velocity)));
  synth_unit_->onParam(58,static_cast<char>(*p(p_op4_output_level)));
  synth_unit_->onParam(59,static_cast<char>(*p(p_op4_mode)));
  synth_unit_->onParam(60,static_cast<char>(*p(p_op4_f_coarse)));
  synth_unit_->onParam(61,static_cast<char>(*p(p_op4_f_fine)));
  ...
  synth_unit_->onParam(71,static_cast<char>(*p(p_op3_break_point)));
  synth_unit_->onParam(72,static_cast<char>(*p(p_op3_l_scale_depth)));
  synth_unit_->onParam(73,static_cast<char>(*p(p_op3_r_scale_depth)));
  synth_unit_->onParam(74,static_cast<char>(*p(p_op3_l_key_curve)));
  synth_unit_->onParam(75,static_cast<char>(*p(p_op3_r_key_curve)));
  synth_unit_->onParam(76,static_cast<char>(*p(p_op3_rate_scaling)));
  synth_unit_->onParam(77,static_cast<char>(*p(p_op3_a_mod_sens)));
  synth_unit_->onParam(78,static_cast<char>(*p(p_op3_key_velocity)));
  synth_unit_->onParam(79,static_cast<char>(*p(p_op3_output_level)));
  synth_unit_->onParam(80,static_cast<char>(*p(p_op3_mode)));
  synth_unit_->onParam(81,static_cast<char>(*p(p_op3_f_coarse)));
  synth_unit_->onParam(82,static_cast<char>(*p(p_op3_f_fine)));
  ...
  synth_unit_->onParam(92,static_cast<char>(*p(p_op2_break_point)));
  synth_unit_->onParam(93,static_cast<char>(*p(p_op2_l_scale_depth)));
  synth_unit_->onParam(94,static_cast<char>(*p(p_op2_r_scale_depth)));
  synth_unit_->onParam(95,static_cast<char>(*p(p_op2_l_key_curve)));
  synth_unit_->onParam(96,static_cast<char>(*p(p_op2_r_key_curve)));
  synth_unit_->onParam(97,static_cast<char>(*p(p_op2_rate_scaling)));
  synth_unit_->onParam(98,static_cast<char>(*p(p_op2_a_mod_sens)));
  synth_unit_->onParam(99,static_cast<char>(*p(p_op2_key_velocity)));
  synth_unit_->onParam(100,static_cast<char>(*p(p_op2_output_level)));
  synth_unit_->onParam(101,static_cast<char>(*p(p_op2_mode)));
  synth_unit_->onParam(102,static_cast<char>(*p(p_op2_f_coarse)));
  synth_unit_->onParam(103,static_cast<char>(*p(p_op2_f_fine)));
  ...
  synth_unit_->onParam(113,static_cast<char>(*p(p_op1_break_point)));
  synth_unit_->onParam(114,static_cast<char>(*p(p_op1_l_scale_depth)));
  synth_unit_->onParam(115,static_cast<char>(*p(p_op1_r_scale_depth)));
  synth_unit_->onParam(116,static_cast<char>(*p(p_op1_l_key_curve)));
  synth_unit_->onParam(117,static_cast<char>(*p(p_op1_r_key_curve)));
  synth_unit_->onParam(118,static_cast<char>(*p(p_op1_rate_scaling)));
  synth_unit_->onParam(119,static_cast<char>(*p(p_op1_a_mod_sens)));
  synth_unit_->onParam(120,static_cast<char>(*p(p_op1_key_velocity)));
  synth_unit_->onParam(121,static_cast<char>(*p(p_op1_output_level)));
  synth_unit_->onParam(122,static_cast<char>(*p(p_op1_mode)));
  synth_unit_->onParam(123,static_cast<char>(*p(p_op1_f_coarse)));
  synth_unit_->onParam(124,static_cast<char>(*p(p_op1_f_fine)));
